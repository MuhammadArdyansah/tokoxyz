<?php
	...
	if(isset($_POST['proses'])){
		...
		if($jum > 0){
			...
			echo '<script>alert("Registrasi Sukses");window.location="index.php"</script>';
		}else{
			echo '<script>alert("Registrasi Suskes");window.location="login.php"</script>';
		}
	}
?>
<!DOCTYPE html>
	  	...
	  	<div class="container">
		      <form class="form-login" method="POST">
		        ...
		        <div class="login-wrap">
		            ...
		            <br>
		            <button class="btn btn-primary btn-block" name="proses" type="submit">REGISTRASI</button>
		            <hr>
